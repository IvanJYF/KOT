(function(){
    ...
    $(".user-search").click(function(){
        var kw = $("kw").val();
        loadpage(0,sessionStorage.uname,kw);
    });
...
function loadpage(pno=0,teacher,kw="",type="",isPast=0){

    $.ajax({
        url:"",
        data:{pno:pno,pSize:9,kw:kw,type:type,isPast:isPast,teacher:teacher},
        type:"get",
